...
namespace netd::shared::request {
  ...
  lyd_node *HelloRequest::toYang([[maybe_unused]] ly_ctx *ctx) const {
    throw netd::shared::NotImplementedError(
        "HelloRequest::toYang not implemented");
  }
  ...
  HelloRequest::fromYang([[maybe_unused]] const ly_ctx *ctx,
    ...
    throw netd::shared::NotImplementedError(
        "HelloRequest::fromYang not implemented");
  }

  std::unique_ptr<HelloRequest> HelloRequest::fromHelloToServer(
      const netd::shared::xml::HelloToServer &hello_to_server) {
