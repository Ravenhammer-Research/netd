...
namespace netd::shared::xml {
  ...
  std::unique_ptr<Hello> Hello::fromXml([[maybe_unused]] const std::string& xml, [[maybe_unused]] const struct ly_ctx* ctx) {
    throw NotImplementedError("Hello::fromXml not implemented");
  }

  std::stringstream Hello::toXmlStream([[maybe_unused]] const struct ly_ctx* ctx) const {
    throw NotImplementedError("Hello::toXmlStream not implemented");
  }

  void Hello::startElementHandler([[maybe_unused]] void* userData, [[maybe_unused]] const XML_Char* name, [[maybe_unused]] const XML_Char** atts) {
    throw NotImplementedError("Hello::startElementHandler not implemented");
  }

  void Hello::endElementHandler([[maybe_unused]] void* userData, [[maybe_unused]] const XML_Char* name) {
    throw NotImplementedError("Hello::endElementHandler not implemented");
  }

  void Hello::characterDataHandler([[maybe_unused]] void* userData, [[maybe_unused]] const XML_Char* s, [[maybe_unused]] int len) {
    throw NotImplementedError("Hello::characterDataHandler not implemented");
  }

  // HelloToClient implementation
  std::unique_ptr<HelloToClient> HelloToClient::toXml(uint32_t sessionId, const std::vector<std::string>& capabilities, [[maybe_unused]] const struct ly_ctx* ctx) {
  ...
  std::stringstream HelloToClient::toXmlStream([[maybe_unused]] const struct ly_ctx* ctx) const {
  ...
  std::unique_ptr<HelloToServer> HelloToServer::fromXml([[maybe_unused]] const std::string& xml, [[maybe_unused]] const struct ly_ctx* ctx) {
    throw NotImplementedError("HelloToServer::fromXml not implemented");
  }

  std::unique_ptr<HelloToServer> HelloToServer::toXml(lyd_node* lyd_data, [[maybe_unused]] const struct ly_ctx* ctx) {
    ...
    if (lyd_data) {
      ...
      if (lyd_print_mem(&xml_str, lyd_data, LYD_XML, LYD_PRINT_WITHSIBLINGS) == LY_SUCCESS) {
